package com.ryderbelserion.crafty.paper.api.config.files;
...
public class PluginSupport implements SettingsHolder {
    ...
    public static final Property<String> COMMAND_PREFIX = PropertyInitializer.newProperty("prefix", "<gradient:#f6426e:#725bf1>[Crafty]</gradient> ");
    ...
    @Comment("How many commands should be displayed per page in /crafty help?")
    ...
    public static final Property<String> HELP_PAGE_HEADER = PropertyInitializer.newProperty(path + "help.page.header", "<dark_gray>────────</dark_gray> <gold>Crafty Help {page}</gold> <dark_gray>────────</dark_gray>");

    public static final Property<String> HELP_PAGE_FOOTER = PropertyInitializer.newProperty(path + "help.page.footer", "<dark_gray>────────</dark_gray> <gold>Crafty Help {page}");
