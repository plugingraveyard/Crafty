package com.ryderbelserion.crafty.paper.api.bootstrap;
...
public class DependencyLoader implements PluginLoader {
    ...
    public void classloader(@NotNull PluginClasspathBuilder classpathBuilder) {
        ...
        resolver.addDependency(new Dependency(new DefaultArtifact("com.ryderbelserion.cluster:cluster-paper:2.7.1"), null));
